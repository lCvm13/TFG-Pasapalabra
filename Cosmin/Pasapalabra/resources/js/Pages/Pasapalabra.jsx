...
export default function PasapalabraForm({ categorias, auth, pasapalabra }) {
  ...
  function handleChange(e) {
    ...
    if (key == 'id_categoria') {
      const categoriaEncontrada = categorias.find(cat => cat.id == value);
      const nombreCategoria = categoriaEncontrada ? categoriaEncontrada.nombre_categoria : "";
      setCategoria(prevCategoria => ({ ...prevCategoria, nombre_categoria: nombreCategoria }));
    }
  }
