                            ...
                            <main className="mt-6">
                                <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                src="/storage/images/icono_p.png"
                                    ...
                                    >
                                        ...
                                        <div className="pt-3 sm:pt-5">
                                            <h2 className="text-xl font-semibold text-black dark:text-white">Preguntas</h2>

                                            <p className="mt-4 text-sm/relaxed">
                                                Inserta las preguntas en la base de datos para usarlas en cualquier pasapalabra personalizado
                                            </p>
                                        </div>
                                    ...
                                    <a
                                        href="#"
                                        className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                                        onClick={auth.user ? showForm : () => alert('Tienes que iniciar sesión')}
                                    >
                                        <div>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 300 300">
                                                ...
                                                <text x="210" y="220" font-family="Arial" font-size="20" fill="#000" text-anchor="middle">D</text>
                                                <text x="150" y="250" font-family="Arial" font-size="20" fill="#000" text-anchor="middle">E</text>
                                                <text x="90" y="220" font-family="Arial" font-size="20" fill="#000" text-anchor="middle">F</text>
                                                <text x="62" y="160" font-family="Arial" font-size="20" fill="#000" text-anchor="middle">G</text>
                                                <text x="90" y="90" font-family="Arial" font-size="20" fill="#000" text-anchor="middle">H</text>
                                            </svg>
                                        ...
                                        <div className="pt-3 sm:pt-5">
                                            <h2 className="text-xl font-semibold text-black dark:text-white">
                                                Crear pasapalabra personalizado
                                            </h2>

                                            <p className="mt-4 text-sm/relaxed">
                                                Puedes crear un pasapalabra personalizado usando las preguntas que previamente has insertado en la base de datos,
                                                el pasapalabra tendrá sus dificultades por si el usuario quiere usar el pasapalabra como estudio u ocio.
                                            </p>
                                        </div>
                                    ...
                                    >
                                        ...
                                        <div className="pt-3 sm:pt-5">
                                            ...
                                            <p className="mt-4 text-sm/relaxed">
                                                Puedes consultar los pasapalabras que has creado en tu cuenta junto a las partidas que has jugado y sus puntuaciones correspondientes
                                            </p>
                                        </div>
